...
RawContent        : HTTP/1.1 200 OK
                    ...
                    Date: Sun, 23 Feb 2025 21:51:03 GMT
                    Server: Docker/27.5.1 (linux)

                    ...
Forms             : {}
Headers           : {[Api-Version, 1.47], [Docker-Experimental, false], [Ostype, linux
                    ], [Content-Length, 3]...}
Images            : {}
InputFields       : {}
Links             : {}
...
하지만 자바 라이브러리 또한 이처럼 도커 데몬의 백엔드 서버에 http 요청을 통해 빠르게 도커 엔진을 제어하는 원리입니다. 만약 다른 라이브러리 또한 안된다면 간단한 도커 엔진의 동작을 다루는 경우 단순한 HttpClient로도 대체할 수 있다고 생각합니다. 
```
